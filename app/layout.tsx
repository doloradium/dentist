...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Первая Европейская Стоматология — стоматология в Луганске',
    template: '%s | Первая Европейская Стоматология',
  },
  description:
    'Первая Европейская Стоматология — современная стоматологическая клиника в Луганске. Имплантация, протезирование, лечение зубов. Запишитесь на приём: +7 (959) 153-40-55.',
  alternates: {
    canonical: SITE_URL,
  },
  openGraph: {
    ...
    description:
      'Современная стоматологическая клиника в Луганске. Имплантация Straumann, протезирование, лечение зубов.',
  },
}
